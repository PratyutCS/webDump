...
function ldabout(obj){
  let about=document.getElementById("about");
  lds(about,obj);
  ldcube(about,obj);
}

function lds(about,obj){
...
function ldcube(about,obj){
  div=document.createElement("div");
  div.className="cube";
  ldtop(div,obs);
  ldbottom(div,obs);
}
function ldtop(div,obs){
  div1=document.createElement("div");
  div1.className="top";
  for(var i=0;i<4;i++){
    h1=document.createElement("h1");
    h1.className="txt1";
    h1.textContent="VOXBOX";
    if(i==0)
    h1.className="we";
    else if(i==1)
    h1.className="er";
...
function ldbottom(div,obs){
  ...
  for(var i=0;i<4;i++){
    ...
    h1=document.createElement("h1");
    h1.className="txt4";
    h1.textContent="PRATYUT";
    h2=document.createElement("h1");
    h2.className="txt2";
    h2.textContent="C.S. Engineer";
    span.appendChild(h1);
    span.appendChild(h2);
    }
    else if(i==1){
    ...
    span.appendChild(h1);
      ...
      h1=document.createElement("h1");
      h1.className="txt3";
      h1.textContent="VOXBOX music management  came up with our mission to create a platform for  artists to allow them to showcase their gift through  music.";
      span.appendChild(h1);
    }
    else if(i==3){
    span.style="--i:3;";
